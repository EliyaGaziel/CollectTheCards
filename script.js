document.addEventListener('DOMContentLoaded', function () {
    ...
    let cards = [
        ...
        { id: 74, name: 'Ageni Card', rarity: 'Epic', price: 200, imageUrl: 'https://crystal-cdn1.crystalcommerce.com/photos/6492544/med-RA5-ajani-mentor-of-heroes.jpg' },
    ...
    function renderInventory() {
        ...
        userInventory.forEach(card => {
            ...
            sellButton.addEventListener('click', function() {
                performTransaction(card.id, 'sell'); // Perform the sell transaction
            });
